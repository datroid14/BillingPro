...
export class ShowInventoryComponent implements OnInit {
  ...
  getInventoryDetails(){
    ...
    var payload = {"data":{"selected_month": this.selectedMonth, "selected_year": this.selectedYear }};
    ...
    this.dashboardService.getInventoryDetails(payload).subscribe(response => {
      ...
      for(var q = 0; q < this.cardDetails.length; q++){
